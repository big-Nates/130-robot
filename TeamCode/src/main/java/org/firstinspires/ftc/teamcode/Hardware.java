...
public class Hardware {
    ...
    public boolean enableTeleopDrive = true;

    private Gamepad gamepad1 = null;
    private Gamepad gamepad2 = null;

    public double robotCommandForwardPower = 0.0;
    public double robotCommandRightwardPower = 0.0;
    public double robotCommandCCWPower = 0.0;

    //Pinpoint Driver
    public GoBildaPinpointDriver odom = null;
...
//    public SampleMecanumDrive drive = null;
    ...
    //Touch Sensors
    public TouchSensor button1 = null;
    public TouchSensor liftRotateHome = null;
    public TouchSensor button3 = null;
    public TouchSensor liftLinearHome = null;
    ...
    public LiftRotate liftRotate = null;

    //SpecimenClaw Servo
    public Servo specimenServo = null;
    public SpecimenClaw specimenClaw = null;

    //LinearLift Motor
    public DcMotorEx linearMotor = null;
...
//        rearDistance = hwMap.get(Rev2mDistanceSensor.class, "rearDistance");
        ...
        //Pinpoint Drive
        odom = hwMap.get(GoBildaPinpointDriver.class, "pinpointDriver");
        odom.setOffsets(68.072, -144.018);
...
//        odom = drive.goBildaLocalizer.getOdometry();
//        localizer = drive.getLocalizer();


        //Touch Sensor
        liftRotateHome = hwMap.get(TouchSensor.class, "liftRotateHome");
        liftLinearHome = hwMap.get(TouchSensor.class, "liftLinearHome");
...
//        imu = hwMap.get(Gyroscope.class, "imu");
        ...
        //Lift Rotate
        rotateMotor = hwMap.get(DcMotorEx.class, "motorRotate");
        rotateMotor.setDirection(DcMotorSimple.Direction.REVERSE);
        rotateMotor.setZeroPowerBehavior(DcMotor.ZeroPowerBehavior.BRAKE);
        liftRotate = new LiftRotate(opMode, this);
        liftRotate.init();

        //Linear Lift
        linearMotor = hwMap.get(DcMotorEx.class, "motorLift");
        linearMotor.setZeroPowerBehavior(DcMotor.ZeroPowerBehavior.BRAKE);
        linearLift = new LinearLift(opMode, this);
        linearLift.init();

        //Sample Intake
        intakeMotor = hwMap.get(DcMotorEx.class, "motorIntake");
        intakeMotor.setZeroPowerBehavior(DcMotor.ZeroPowerBehavior.BRAKE);
        sampleIntake = new SampleIntake(opMode, this);
        sampleIntake.init();

        //Specimen Claw
        specimenServo = hwMap.get(Servo.class, "specimenServo");
        specimenClaw = new SpecimenClaw(opMode, this);
        specimenClaw.init();
...
//        ernie.init();
    ...
    public void start() {
        ...
        updatePreviousValues();
        odom.resetPosAndIMU();
        odom.setPosition(new Pose2D(DistanceUnit.INCH,0, 0, AngleUnit.RADIANS, 0)); //TODO: Assign to actualy starting pose
    }
...
//                    drive.rightRear.getVelocity(),
                    ...
                    odom.getPosX(),
                    odom.getPosY(),
                    Math.toDegrees(odom.getHeading()),
